...
<div id="manual" class="content">
	<ul id="manual-menu" class="tabs">
		...
		<li class="tab"><a class="primary" href="chronologies">{t d='arkeogis' m='Chronologie'}</a></li>
		...
		<li class="tab"><a class="primary" href="production">{t d='arkeogis' m='Production'}</a></li>
